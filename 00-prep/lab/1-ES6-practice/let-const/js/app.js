...
function displayPics(){
  ...
  //The reason why let does not work here, and var does, is because var gives the scope for the variable to be used later. let on the other hand keeps the variable within the code block and it is not accessable by other portions of the called. ie. It is unable to be called upon, and therefore unable to interact with the rest of the code.
  console.log(viewed);
